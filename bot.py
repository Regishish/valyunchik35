...
{"text": "🍽 Задание 7: Выбери ресторан, где мы отметим твой праздник. Напиши номер: 1, 2 или 3. Вот список:\n\n1. Квартал View\n2. Плакучая Ива\n3. Реззо"
...
},
{
    ...
    "options": {
        "С тобой всегда спокойно": (False, "Это только часть!"),
...
},
{
        ...
        "options": {
            ...
            "Силой": (False, "Мой Халк😅"),
            "А надо всем вместе 💪🧠🧘‍♂️": (True, "✅ Имеешь право!")
}
},
{

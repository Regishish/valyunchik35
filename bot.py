...
photos_with_captions = [
    ...
    ("IMG_9111.jpeg", "Ты — мой дом и моя свобода одновременно."),
    ("IMG_4979.jpeg", "Я люблю твою улыбку. Она обезоруживает."),
    ("IMG_5377.jpeg", "Ты самый красивый мужчина из всех, кого я знаю."),
    ("IMG_5390.jpeg", "Ты всегда был моей опорой. И будешь."),
    ("IMG_5863.jpeg", "Люблю, когда ты смотришь так, как на этом фото."),
    ("IMG_6353.jpeg", "Ты умеешь быть разным — и я любуюсь каждым твоим состоянием."),
    ("IMG_7087.jpeg", "Ты делаешь мою жизнь вкусной — и в прямом, и в переносном смысле."),
    ...
    ("TXD5wkJc.jpeg", "Ты — моё утро. Моё солнце. Моя любовь."),
]

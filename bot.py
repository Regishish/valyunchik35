...
},
{
        ...
        "options": {
    "opt1": (False, "Хм... не всегда 😅", "Видеть хаос и оставаться спокойным"),
    "opt2": (False, "Почти 😉", "Быть мужчиной мечты"),
    "opt3": (False, "Это да, но не только!", "Находить вкусную еду"),
    "opt4": (False, "Правда... но не суперспособность 😆", "Занимать всю кровать"),
    "opt5": (True, "✅ Идеальный набор 💪", "Всё вместе")
}
},
{
